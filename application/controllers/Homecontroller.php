...
if ($this->input->post()) {
            ...
            $this->db->insert('registrations', $formData);

                   echo '<script>alert("Registered Successfully!"); window.location.href = "' . base_url('registration') . '";</script>';
         ...
         for($i = 0; $i < $ImageCount; $i++){
             ...
             if($this->upload->do_upload('file')){
               ...
               $this->session->set_flashdata("Successs","Blog Added Successfuly !");
                 ...
                 $blogcontent=$this->input->post('blogcontent');
                 $blogdate=$this->input->post('blogdate');
                if(empty($_FILES['blogimage']['name'])){$blogimage = $this->input->post('pimage2p');} else{$blogimage = $picture1;}



               $data['slt']= $this->category->editblog($blogimage,$blogcontent,$blogdate,$id);
               $this->session->set_flashdata("Successs","Blog Edited Successfuly !");
