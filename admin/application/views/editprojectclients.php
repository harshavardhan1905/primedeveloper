                    ...
                    <div class="row">
                        <div class="px-4 col-md-12">
                            <div class="flex flex-wrap items-center justify-between">
                                <div>
                                    <h1 class="text-white mb-2 mr-16">Projects Clients</h1>
    ...
    <div class="p-6 lg:p-8 footer-inner  mx-auto main-container  lg:py-0 py-0 " x-bind:class="setting.page_layout">
        ...
        <div class="relative flex flex-col mb-8  bg-white dark:bg-dark-card shadow rounded">
            <div class="flex justify-between flex-auto p-5 border-b dark:border-secondary-800 rounded">
                <h4 class="mb-0 dark:text-secondary-200">Add New Client</h4>
            </div>
...
<div class="flex flex-wrap contet-inner">
    <div class="flex-auto w-full">
        <div class="relative flex flex-col mb-8  bg-white dark:bg-dark-card shadow rounded">
            <div class="flex justify-between flex-auto p-5 border-b dark:border-secondary-800 rounded">
                <h4 class="mb-0 dark:text-secondary-200">Projects Clients List</h4>
            </div>
                             ...
                             foreach($list as $val){?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-secondary-600 dark:text-secondary-500">
                                        <img style="height:100px; width:100px;" src="<?php echo base_url()?>/uploads/products/<?=$val->cname?>"/>
                                        </td>
                                  
                                    <td class="px-6 py-4">


                                           <a href="<?php echo base_url()?>homecontroller/deleteprojectclient/<?=$val->id?>" style="margin-left:2%"><button type="button" style="padding:4px" class="btn btn-primary mb-2 btn-sm">Delete Project</button></a>
