...
<?php include('templates/header.php');?>
  ...
  <div class="col-md-12">
                      ...
                      <div class="template-demo">
                        <a href="<?php echo base_url()?>addcategory"><button type="button" class="btn btn-outline-danger btn-icon-text">
                   ...
                   $i=1;
					  ...
					  <td><strong><?= $i?></strong></td>
                        ...
                        <td>
						  ...
						  <a  href="<?php echo base_url();?>homecontroller/editcategory/<?= $val->id?>"> <button type="button" class="btn btn-primary btn-sm btn-icon-text mr-3">Edit <i class="typcn typcn-edit btn-icon-append"></i></button></a>
							
              <a href="<?php echo base_url();?>homecontroller/deletecategory/<?= $val->id?>" onclick="return confirm('Are you sure you want to delete?')">   <button type="button" class="btn btn-primary btn-sm btn-icon-text">Delete <i class="typcn typcn-delete-outline btn-icon-append"></i></button></a>    
