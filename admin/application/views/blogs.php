                    ...
                    <div class="row">
                        <div class="px-4 col-md-12">
                            <div class="flex flex-wrap items-center justify-between">
                                <div>
                                    <h1 class="text-white mb-2 mr-16">Blogs</h1>
                                
                                </div>
                                <div>
                                    <a href="<?php echo base_url()?>homecontroller/addblog"
    ...
    <div class="flex-auto w-full">
        <div class="relative flex flex-col mb-8  bg-white dark:bg-dark-card shadow rounded">
            <div class="flex justify-between flex-auto p-5 border-b dark:border-secondary-800 rounded">
                <h4 class="mb-0 dark:text-secondary-200">Blog List</h4>
            </div>
                   ...
                   $i=0;
                             foreach($list as $val){  $i = $i +1;?>
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-secondary-600 dark:text-secondary-500"><?=$val->blogtitle?></td>
                                    <td class="px-6 py-4">


                                           <a href="<?php echo base_url()?>homecontroller/editblog/<?=$val->id?>"><button type="button" style="padding:4px" class="btn btn-primary mb-2 btn-sm">Edit Blog</button></a>
                                           
                                           <a href="<?php echo base_url()?>homecontroller/deleteblog/<?=$val->id?>" style="margin-left:2%"><button type="button" style="padding:4px" class="btn btn-primary mb-2 btn-sm">Delete Blog</button></a>
