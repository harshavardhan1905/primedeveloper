...
<?php include('templates/header.php');?>
 ...
 <div class="text-white h-48 sub-header" style="rgb(0 155 222)">
                    ...
                    <div class="w-full">
                            ...
                            <div class="mb-4">
                                <label class="inline-block mb-2 text-secondary-600 dark:text-white">Location:
                                    *</label>
                             <input type="text"  class="w-full px-4 py-2 placeholder-secondary-400 border dark:bg-dark-card dark:border-secondary-800 rounded outline-none focus:border-primary-500 dark:focus:border-primary-500 focus:shadow" name="location" aria-label="Default select example">
                   ...
                   <div class="w-full">
                            ...
                            <div class="mb-4">
                                <label class="inline-block mb-2 text-secondary-600 dark:text-white">Total Buildings:
                                    *</label>
                             <input type="text"  class="w-full px-4 py-2 placeholder-secondary-400 border dark:bg-dark-card dark:border-secondary-800 rounded outline-none focus:border-primary-500 dark:focus:border-primary-500 focus:shadow" name="totalbuildings" aria-label="Default select example">
                    ...
                    <div class="w-full">
                            ...
                            <div class="mb-4">
                                <label class="inline-block mb-2 text-secondary-600 dark:text-white">Available:
                                    *</label>
                             <input type="text"  class="w-full px-4 py-2 placeholder-secondary-400 border dark:bg-dark-card dark:border-secondary-800 rounded outline-none focus:border-primary-500 dark:focus:border-primary-500 focus:shadow" name="available" aria-label="Default select example">
                   ...
                   <div class="w-full">
                            ...
                            <div class="mb-4">
                                <label class="inline-block mb-2 text-secondary-600 dark:text-white">Units Sold:
                                    *</label>
                             <input type="text"  class="w-full px-4 py-2 placeholder-secondary-400 border dark:bg-dark-card dark:border-secondary-800 rounded outline-none focus:border-primary-500 dark:focus:border-primary-500 focus:shadow" name="unitsold" aria-label="Default select example">
                     ...
                     <div class="w-full">
                            ...
                            <div class="mb-4">
                                <label class="inline-block mb-2 text-secondary-600 dark:text-white">Url:
                                    *</label>
                             <input type="text"  class="w-full px-4 py-2 placeholder-secondary-400 border dark:bg-dark-card dark:border-secondary-800 rounded outline-none focus:border-primary-500 dark:focus:border-primary-500 focus:shadow" name="urlt" aria-label="Default select example">
